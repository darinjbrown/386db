...
courseRouter.get('/:term', CourseController.allCoursesForTerm);
courseRouter.get('/:subject', CourseController.allCoursesBySubject);
courseRouter.get('/', CourseController.allCourses);
courseRouter.get('/:catalog', CourseController.allCoursesByCatalog);
courseRouter.get('/:subject/:catalog', CourseController.allCoursesBySubjectAndCatalog);
